...
args = sys$cmd$parse(
    ...
    opt('d', 'dna_ins', '', '../cis_analysis/analysis_set.rds'),
    opt('m', 'meta', 'metadata', '../ploidy_compare/analysis_set.rds'),
...
genes = seq$coords$gene(dset="mmusculus_gene_ensembl", assembly="GRCm38", granges=TRUE) # get this from txdb?
